...
Set-ItemProperty -Path . -Name removePrograms -Value 'C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -File C:\PS_RunOnce\Everything_Script_Mk_II.ps1'
} else {
Set-Location -Path HKCU:\Software\Microsoft\Windows\CurrentVersion
New-Item -Path . -Name RunOnce
Set-ItemProperty -Path .\RunOnce -Name removePrograms -Value 'C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -File C:\PS_RunOnce\Everything_Script_Mk_II.ps1'
}
